namespace Kingpinbot
{
	...
	internal class Program
	{
		...
		private static void Main(string[] args)
		{
			...
			sounds.Add("Тебе это не под силу.", "https://dl.dropbox.com/s/okko1mf3bvpedd3/EtoDeloNeDlyaTebya.mp3");
			sounds.Add("Это ты мне?", "https://dl.dropbox.com/s/ms591r187azf8ac/EtoTiMne.mp3");
			sounds.Add("Иди ты.", "https://dl.dropbox.com/s/51w8fq75obi2v4o/Pnh.mp3");
			sounds.Add("Не стоит беспокойства.", "https://dl.dropbox.com/s/mb9n0xrdcdwozhq/VseHuinya.mp3");
